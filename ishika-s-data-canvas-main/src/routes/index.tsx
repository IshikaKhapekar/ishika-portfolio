...
import {
  Github, Linkedin, Mail, Award, Download, ExternalLink, MapPin, ArrowRight,
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Button asChild size="lg" variant="outline" className="border-primary/40 hover:bg-primary/10 hover:text-primary">
                <a
                  href="https://drive.google.com/drive/folders/1xJZxkSh0Nuk_7PRrdCbi1J4AGJDy62AX"
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={(e) => {
                    e.preventDefault();
                    window.open(
                      "https://drive.google.com/drive/folders/1xJZxkSh0Nuk_7PRrdCbi1J4AGJDy62AX",
                      "_blank",
                      "noopener,noreferrer",
                    );
                  }}
