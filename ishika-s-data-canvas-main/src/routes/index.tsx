...
function Portfolio() {
  ...
  const onContact = async (e: FormEvent<HTMLFormElement>) => {
    ...
    setSending(true);
    try {
      const response = await fetch("https://formsubmit.co/ajax/ishikakhapekar6@gmail.com", {
        method: "POST",
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground antialiased">
      ...
      <Dialog open={resumeOpen} onOpenChange={setResumeOpen}>
        <DialogContent className="h-[88vh] w-[94vw] max-w-4xl overflow-hidden border-border/60 bg-card/95 p-0 backdrop-blur-xl sm:rounded-xl">
          <DialogHeader className="border-b border-border/60 px-5 py-4 text-left">
            <DialogTitle className="text-lg">Ishika Khapekar Resume</DialogTitle>
            <DialogDescription>Resume preview — opens directly on this screen</DialogDescription>
          </DialogHeader>
          <div className="h-[calc(88vh-76px)] overflow-y-auto bg-background/70 px-3 py-4 sm:px-6">
            {["/resume-page-1.png", "/resume-page-2.png"].map((src, index) => (
              <img
                key={src}
                src={src}
                alt={`Ishika Khapekar resume page ${index + 1}`}
                className="mx-auto mb-5 h-auto w-full max-w-3xl rounded-md border border-border/60 bg-card shadow-2xl"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a href="mailto:ishikakhapekar6@gmail.com" className="flex items-center gap-3 rounded-lg border border-border/60 bg-card/60 p-3 transition-all hover:border-primary hover:text-primary">
                <Mail className="h-4 w-4 text-primary" /><span>ishikakhapekar6@gmail.com</span>
              </a>
              <a href="https://www.linkedin.com/in/ishika-khapekar-a068182ab" target="_blank" rel="noreferrer" className="flex items-center gap-3 rounded-lg border border-border/60 bg-card/60 p-3 transition-all hover:border-primary hover:text-primary">
                <Linkedin className="h-4 w-4 text-primary" /><span>linkedin.com/in/ishika-khapekar</span>
              </a>
              <a href="https://github.com/IshikaKhapekar" target="_blank" rel="noreferrer" className="flex items-center gap-3 rounded-lg border border-border/60 bg-card/60 p-3 transition-all hover:border-primary hover:text-primary">
                <Github className="h-4 w-4 text-primary" /><span>github.com/IshikaKhapekar</span>
              </a>
              <a href="https://www.credly.com/users/ishika-khapekar/badges#credly" target="_blank" rel="noreferrer" className="flex items-center gap-3 rounded-lg border border-border/60 bg-card/60 p-3 transition-all hover:border-primary hover:text-primary">
                <Award className="h-4 w-4 text-primary" /><span>credly.com/users/ishika-khapekar</span>
              </a>
            </div>
          </div>
